          ...
          @endif
            ...
            <table class="center">
                ...
                <tr>
                    ...
                    <td><a class="btn btn-danger" onclick="return confirm('Are You Want to Delete This?')" href="{{url('delete_product',$product->id)}}">Delete</a></td>
